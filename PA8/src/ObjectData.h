...
class ObjectData 
{
 public:
    ...
    // create a new object
    void addObject(int objNum, btCollisionShape *shape, btDefaultMotionState *motionState, btScalar mass, btVector3 inertia, GLuint VBO, int numbTri, float scale, btRigidBody* rigidBody);
