...
void ObjectData::addObject(int objNum, btCollisionShape *shape, btDefaultMotionState *motionState, btScalar mass, btVector3 inertia, GLuint VBO, int numbTri, float scale, btRigidBody* rigidBody)
{
